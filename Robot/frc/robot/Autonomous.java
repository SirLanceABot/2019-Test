...
public class Autonomous
{
    ...
    private int angle;
    private TargetDataB targetData;        
    ...
    */
    ...
    public boolean whiteLineAlignment()
    {
        ...
        {
            CameraProcessB.rotate rotation = vision.getRotateDirection(targetData)B;
            double rotationFactor = vision.getRotateFactor(targetDataB);
            CameraProcess.strafeDirection strafeDirection = vision.getStrafeDirection(targetDataB);
            double strafeDirectionFactor = vision.getStrafeFactor(targetDataB);
